...
<script>
	export let onclick = () =>{};
	export let tooltip = '';
	export let color = 'red'; // bisa indigo, red, green, dst
</script>

<button on:click={onclick} class="group relative text-{color}-600 hover:cursor-pointer hover:text-{color}-900">
	<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24">
		<path
			fill="currentColor"
			fill-rule="evenodd"
			d="M10.31 2.25h3.38c.217 0 .406 0 .584.028a2.25 2.25 0 0 1 1.64 1.183c.084.16.143.339.212.544l.111.335l.03.085a1.25 1.25 0 0 0 1.233.825h3a.75.75 0 0 1 0 1.5h-17a.75.75 0 0 1 0-1.5h3.09a1.25 1.25 0 0 0 1.173-.91l.112-.335c.068-.205.127-.384.21-.544a2.25 2.25 0 0 1 1.641-1.183c.178-.028.367-.028.583-.028"
		/>
		<path
			fill="currentColor"
	...
	<span
		class="absolute -top-8 left-1/2 -translate-x-1/2 whitespace-nowrap
           rounded bg-red-800 px-2 py-1 text-xs text-white opacity-0
